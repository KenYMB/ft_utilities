...
% using: ft_private(fetch_url, filetype_check_uri), ft_fix(load_nifti, load_mgh)

% 20170206 Yuasa: comment out the exception for win
% 20170626 Yuasa: add 'ft_fix' after 'ft_hastoolbox'
