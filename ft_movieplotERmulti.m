function [cfg] = ft_movieplotERmulti(cfg, data)
...
for l = 1:numel(data)
    data{l} = ft_checkdata(data{l}, 'datatype', 'timelock');
end
...
if ~strcmp(cfg.baseline, 'no')
  ...
  for l = 1:numel(data)
      data{l} = ft_timelockbaseline(tmpcfg, data{l});
...
cfg = ft_movieplotTFRmulti(cfg, data);
